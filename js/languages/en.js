export default {
  ...
  btn_code: "Code",
  btn_live: "Live demo",
  aria_navigation: "Main navigation",
  aria_nav_open: "Open menu",
  aria_nav_close: "Close menu",
  aria_settings: "Open preferences",
  ...
  nav_cv: "Download CV PDF",

  // Profile
  profile_role: "Full Stack Developer",
  hero_eyebrow: "Full Stack Developer",
  hero_intro:
    "I build complete web applications focused on business logic, databases, and clear interfaces.",
  hero_cta_project: "View featured project",
  hero_cta_contact: "Contact me on LinkedIn",
  about_summary: "More about me",
  profile_bio: `
    <p>
      I am a Full Stack Developer who enjoys turning real needs into complete web applications. I am particularly interested in understanding how a business works, organizing its processes, and translating them into useful, intuitive, and maintainable solutions.
    </p>
    <p>
      My main strengths are business logic, database design, and the creation of clear interfaces. Across my projects, I have worked with authentication, role-based permissions, transactional operations, APIs, payments, invoicing, inventory management, and administration panels, paying attention to both internal structure and the end-user experience.
    </p>
    <p>
      I hold a Higher Technician Degree in Web Application Development (DAW) and continue expanding my skills. I am looking to grow within teams where I can contribute a practical perspective, learn from other professionals, and take part in products with meaningful technical challenges and clear objectives.
    </p>
    <p>
      At the end of the portfolio, you will also find a section featuring small video games that I build to practise logic, algorithms, state management, and interface design. I believe these projects complement web development particularly well because they encourage creative problem-solving and help create more dynamic user experiences.
    </p>
  `,
  ...
  tools_title: "Tools",
  integrations_title: "APIs & Integrations",
  projects_title: "Web projects",
  games_title: "Video games",
  featured_eyebrow: "Featured project",
  featured_title: "A real store, not just a demonstration",
  featured_intro:
  ...
  technologies_summary: "View full stack",
  footer_text: "Applications combining logic, data, and interfaces designed for people.",
