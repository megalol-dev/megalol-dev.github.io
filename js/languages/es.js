export default {
  ...
  site_title: "José Luis Escudero · Full Stack Developer",
  ...
  btn_code: "Código",
  btn_live: "Ver demo",
  aria_navigation: "Navegación principal",
  aria_nav_open: "Abrir menú",
  aria_nav_close: "Cerrar menú",
  aria_settings: "Abrir preferencias",
  aria_back_top: "Volver arriba",
  ...
  nav_cv: "Descargar CV PDF",

  // Perfil
  profile_role: "Desarrollador Full Stack",
  hero_eyebrow: "Full Stack Developer",
  hero_intro:
    "Desarrollo aplicaciones web completas centradas en lógica de negocio, bases de datos e interfaces claras.",
  hero_cta_project: "Ver proyecto destacado",
  hero_cta_contact: "Contactar por LinkedIn",
  about_summary: "Más sobre mí",
  profile_bio: `
    <p>
      Soy desarrollador Full Stack y disfruto transformando necesidades reales en aplicaciones web completas. Me interesa especialmente entender cómo funciona un negocio, ordenar sus procesos y convertirlos en soluciones útiles, intuitivas y fáciles de mantener.
    </p>
    <p>
      Mis principales fortalezas son la lógica de negocio, el diseño de bases de datos y la creación de interfaces claras. En mis proyectos he trabajado con autenticación, permisos por roles, operaciones transaccionales, APIs, pagos, facturación, gestión de inventario y paneles administrativos, cuidando tanto la estructura interna como la experiencia de quien utiliza la aplicación.
    </p>
    <p>
      Soy Técnico Superior en Desarrollo de Aplicaciones Web (DAW) y mantengo una formación continua. Busco seguir creciendo en equipos donde pueda aportar una visión práctica, aprender de otros profesionales y participar en productos con retos técnicos y objetivos concretos.
    </p>
    <p>
      Al final del portfolio también encontrarás una sección de pequeños videojuegos que desarrollo para practicar lógica, algoritmos, gestión de estados y diseño de interfaces. Considero que este tipo de proyectos complementa muy bien el desarrollo web porque ayuda a resolver problemas de forma creativa y a construir experiencias más dinámicas para el usuario.
    </p>
  `,

  // Tecnologías y secciones
  ...
  integrations_title: "APIs e integraciones",
  projects_title: "Proyectos web",
  games_title: "Videojuegos",
  featured_eyebrow: "Proyecto destacado",
  featured_title: "Una tienda real, no solo una demostración",
  featured_intro:
  ...
  technologies_summary: "Ver stack completo",
  footer_text: "Aplicaciones con lógica, datos e interfaces pensadas para personas.",

  // UrbanSneakers
  urban_title: "UrbanSneakers",
